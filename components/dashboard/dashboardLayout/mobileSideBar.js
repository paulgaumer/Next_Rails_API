    ...
    <div className={`${sidebarOpen ? 'block' : 'hidden'} md:hidden`}>
      ...
      <div className="fixed inset-0 z-40 flex">
        <div
          ...
          className="flex flex-col flex-1 w-full max-w-xs duration-300 ease-in-out transform bg-blue-800 "
        >
          <div
          ...
          <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
            ...
            <nav className="flex-1 px-2 mt-5 bg-blue-800">
              <Link href="/dashboard">
                <a
                  className={`${
                    currentPath === '/dashboard'
                      ? 'text-white bg-blue-900'
                      : 'mt-1 text-blue-300 hover:text-white hover:bg-blue-700 focus:text-white'
                  } group flex items-center px-2 py-2 text-sm leading-5 font-medium rounded-md focus:outline-none focus:bg-blue-700 transition ease-in-out duration-150`}
                >
                  <svg
                    className="w-6 h-6 mr-3 text-blue-400 transition duration-150 ease-in-out group-focus:text-blue-300"
                    stroke="currentColor"
                    fill="none"
                    viewBox="0 0 24 24"
                  >
              ...
              <Link href="/dashboard/podcast">
                ...
                >
                  <svg
                    ...
                    strokeWidth="2"
                    viewBox="0 0 24 24"
                    className="w-6 h-6 mr-3 text-blue-400 transition duration-150 ease-in-out group-hover:text-blue-300 group-focus:text-blue-300"
                  >
              ...
              <div className="mt-2 border-t border-blue-700">
                <a
                  href={`http://${podcastSubdomain}.${currentDomain}`}
                  target="_blank"
                  className="flex items-center px-2 py-2 mt-1 text-sm font-medium leading-5 text-blue-300 transition duration-150 ease-in-out rounded-md group hover:text-white hover:bg-blue-700 focus:outline-none focus:text-white focus:bg-blue-700"
                >
                  <svg
                    fill="none"
                    stroke="currentColor"
          ...
          <div className="px-2 py-4">
            <a
              ...
              className="flex items-center px-2 py-2 mt-1 text-sm font-medium leading-5 text-blue-300 transition duration-150 ease-in-out rounded-md cursor-pointer group hover:text-white hover:bg-blue-700 focus:outline-none focus:text-white focus:bg-blue-700"
            >
              <svg
                fill="none"
                stroke="currentColor"
          ...
          <div className="px-2 py-1 border-t border-blue-700">
